    ...
    <>
      <div className="col-12 col-md-6">
        <div className="card p-3" data-aos="fade-up">
          ...
          <p className="fw-light mb-2">
            Royal Defense is proud to present Royal Vision, a cutting-edge software solution capable
            of reading Egyptian license plates with utmost precision and efficiency.
          </p>
          <p className="fw-light mb-2">
      ...
      <div className="col-12 col-md-6" data-aos="fade-up">
        <div className="card p-3">
          ...
          <p className="fw-light mb-2">
            Welcome to the future of parking management – where efficiency meets innovation, and
            convenience intertwines with cutting-edge technology.
          </p>
          <p className="fw-light mb-2">
            Say hello to RPM, your gateway to a smarter, more streamlined parking experience.
            Whether you're a parking facility owner aiming to boost revenue or a driver tired of the
            endless search for the perfect spot, RPM is here to transform the way we think about
            parking.
          </p>
          <p className="fw-light mb-2">
            Fasten your seatbelts as we take you on a ride through the world of intelligent space
            allocation, user-friendly interfaces, and a parking revolution like never before.
          </p>
          <button className="rdBtn mainBtn">
            <Link href="/software">Know more</Link>
          </button>
